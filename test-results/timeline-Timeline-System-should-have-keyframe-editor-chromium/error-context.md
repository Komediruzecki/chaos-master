...
- Name: timeline.spec.ts >> Timeline System >> should have keyframe editor
- Location: tests/timeline.spec.ts:21:3
...
Locator: locator('[data-testid="keyframe-editor"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="keyframe-editor"]')
