...
- Name: timeline.spec.ts >> Timeline System >> should render correctly with initial timeline state
- Location: tests/timeline.spec.ts:86:3
...
Call log:
  - waiting for locator('[data-testid="timeline-panel"]') to be visible
