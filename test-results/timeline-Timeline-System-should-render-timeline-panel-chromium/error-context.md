...
- Name: timeline.spec.ts >> Timeline System >> should render timeline panel
- Location: tests/timeline.spec.ts:8:3
...
Locator: locator('[data-testid="timeline-panel"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="timeline-panel"]')
