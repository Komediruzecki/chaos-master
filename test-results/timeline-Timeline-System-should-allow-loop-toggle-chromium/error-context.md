...
- Name: timeline.spec.ts >> Timeline System >> should allow loop toggle
- Location: tests/timeline.spec.ts:63:3
...
Call log:
  ...
  - waiting for locator('#loop-toggle')
