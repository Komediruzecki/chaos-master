...
- Name: timeline.spec.ts >> Timeline System >> should play/pause timeline
- Location: tests/timeline.spec.ts:72:3
...
Locator: locator('button[aria-label="Play"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button[aria-label="Play"]')
