...
- Name: timeline.spec.ts >> Timeline System >> should show timeline ruler with keyframe markers
- Location: tests/timeline.spec.ts:13:3
...
Locator: locator('[data-testid="timeline-ruler"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="timeline-ruler"]')
